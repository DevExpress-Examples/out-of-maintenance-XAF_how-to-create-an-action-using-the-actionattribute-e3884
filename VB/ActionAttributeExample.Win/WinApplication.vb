...
Namespace ActionAttributeExample.Win
    Partial Public Class ActionAttributeExampleWindowsFormsApplication
        ...
        Private Sub ActionAttributeExampleWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
#If EASYTEST Then
            e.Updater.Update()
            e.Handled = True
#Else
